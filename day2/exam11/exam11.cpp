    ...
    case WM_PAINT:
        {
			...
			//myBitmap = LoadBitmap(hInst, MAKEINTRESOURCE(???));
			//oldBitmap = (HBITMAP)SelectObject(hdc, myBitmap);
			...
			Rectangle(hdc, 100, 100, 500, 350);

			HFONT myFont, oldFont;
			myFont = CreateFont(40, 0, 0, 0, 0, 0, 0, 0, HANGUL_CHARSET, 0, 0, 0, 0, L"궁서체");
			...
			myFont1 = CreateFont(30, 0, 0, 0, 0, 0, 0, 0, HANGUL_CHARSET, 0, 0, 0, 0, L"맑은 고딕");
			oldFont1 = (HFONT)SelectObject(hdc, myFont1);

			TCHAR szMsg2[] = L"사원      홍길동";
			SetBkMode(hdc, TRANSPARENT);
			TextOut(hdc, 300, 250, szMsg2, wcslen(szMsg2));

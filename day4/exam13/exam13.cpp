...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		CreateWindow(L"button", L"빼기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 + 100, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4002, hInst, NULL);

		CreateWindow(L"button", L"곱하기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 + 200, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4003, hInst, NULL);

		CreateWindow(L"button", L"나누기",
			WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
			10 + 300, 10 + 25 + 5, 100, 25, hWnd, (HMENU)4004, hInst, NULL);
	}
		break;
    case WM_COMMAND:
        {
			...
			case 4002:
			{
				...
				swprintf_s(szOutput, 256, L"차는 %d", sub);
